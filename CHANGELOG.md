...
Documentation correction release for the dali-ui **v2.5.36.11230** compatibility
update. The renderer binaries are unchanged from v0.18.2.

### Changed

- Correct the v0.18.2 release notes to record the image-loading API adaptation
  that is present in the released source.

### Compatibility

- Uses dali-ui `v2.5.36.11230` with `dali2-core`/`dali2-adaptor` `dali_2.5.37`.
- Conformance: 145/145; gallery pixel-regression gate: PASS 36/36.

## [0.18.2] — 2026-09-03

Automated release tracking **dali-ui v2.5.36.11230** (with `dali2-core` / `dali2-adaptor` `dali_2.5.37`).
...
- Built against `dali-ui v2.5.36.11230` with `dali2-core`/`dali2-adaptor` `dali_2.5.37` on the
